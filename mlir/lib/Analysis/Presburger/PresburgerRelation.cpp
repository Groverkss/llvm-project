...
void PresburgerRelation::unionInPlace(const IntegerRelation &disjunct) {
  assert(space.isSpaceCompatible(disjunct.getSpace()) && "Spaces should match");
...
void PresburgerRelation::unionInPlace(const PresburgerRelation &set) {
  assert(space.isSpaceCompatible(set.getSpace()) && "Spaces should match");
...
static PresburgerRelation getSetDifference(IntegerRelation b,
  ...
  assert(b.getSpace().isSpaceCompatible(s.getSpace()) && "Spaces should match");
