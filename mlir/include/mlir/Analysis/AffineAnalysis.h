...
struct MemRefAccess {
  ...
  /// Creates an access relation for the access. An access relation maps elements
  ...
  /// For example, given the MLIR code:
  ///
  ...
  ///   0  <= %i1 < 10
  /// 
  /// Returns failure if the access relation coulkd not be created.
