...
//       CHECK:   %[[out:.*]] = vector.gather %[[m]][%[[c0]], %[[c0]]] [%[[v]]: vector<16xi32>], %[[mask]], %[[pass_thru]] : memref<?x?xf32>, vector<16xi1>, vector<16xf32> into vector<16xf32>
func.func @gather(%base: tensor<?x?xf32>, %v: vector<16xi32>, %v2: vector<16xi32>, %mask: vector<16xi1>, %pass_thru: vector<16xf32>) -> vector<16xf32> {
  %c0 = arith.constant 0 : index
  %0 = vector.gather %base[%c0, %c0][%v : vector<16xi32>, %v2: vector<16xi32>], %mask, %pass_thru : tensor<?x?xf32>, vector<16xi1>, vector<16xf32> into vector<16xf32>
