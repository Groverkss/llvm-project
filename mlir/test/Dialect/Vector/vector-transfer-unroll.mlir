...
// CHECK-NEXT:    %[[VGT0:.*]] = vector.gather {{.*}}[%[[IDX0]]: vector<2x2xindex>], %[[MASK0]], %[[PASS0]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// CHECK-NEXT:    %[[VGT1:.*]] = vector.gather {{.*}}[%[[IDX1]]: vector<2x2xindex>], %[[MASK1]], %[[PASS1]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// CHECK-NEXT:    %[[VGT2:.*]] = vector.gather {{.*}}[%[[IDX2]]: vector<2x2xindex>], %[[MASK2]], %[[PASS2]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// CHECK-NEXT:    %[[VGT3:.*]] = vector.gather {{.*}}[%[[IDX3]]: vector<2x2xindex>], %[[MASK3]], %[[PASS3]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// CHECK-NEXT:    %[[VGT4:.*]] = vector.gather {{.*}}[%[[IDX4]]: vector<2x2xindex>], %[[MASK4]], %[[PASS4]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// CHECK-NEXT:    %[[VGT5:.*]] = vector.gather {{.*}}[%[[IDX5]]: vector<2x2xindex>], %[[MASK5]], %[[PASS5]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// ORDER-NEXT:    %[[VGT0:.*]] = vector.gather {{.*}}[%[[IDX0]]: vector<2x2xindex>], %[[MASK0]], %[[PASS0]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// ORDER-NEXT:    %[[VGT1:.*]] = vector.gather {{.*}}[%[[IDX1]]: vector<2x2xindex>], %[[MASK1]], %[[PASS1]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// ORDER-NEXT:    %[[VGT2:.*]] = vector.gather {{.*}}[%[[IDX2]]: vector<2x2xindex>], %[[MASK2]], %[[PASS2]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// ORDER-NEXT:    %[[VGT3:.*]] = vector.gather {{.*}}[%[[IDX3]]: vector<2x2xindex>], %[[MASK3]], %[[PASS3]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// ORDER-NEXT:    %[[VGT4:.*]] = vector.gather {{.*}}[%[[IDX4]]: vector<2x2xindex>], %[[MASK4]], %[[PASS4]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
...
// ORDER-NEXT:    %[[VGT5:.*]] = vector.gather {{.*}}[%[[IDX5]]: vector<2x2xindex>], %[[MASK5]], %[[PASS5]] : memref<?xf32>, vector<2x2xi1>, vector<2x2xf32> into vector<2x2xf32>
// ORDER-NEXT:    %[[VEC5:.*]] = vector.insert_strided_slice %[[VGT5]], %[[VEC4]] {offsets = [4, 2], strides = [1, 1]} : vector<2x2xf32> into vector<6x4xf32>
// ORDER-NEXT:    return %[[VEC5]] : vector<6x4xf32>

func.func @vector_gather_unroll(%mem : memref<?xf32>,
                                %indices : vector<6x4xindex>,
                                %mask : vector<6x4xi1>,
                                %pass_thru : vector<6x4xf32>) -> vector<6x4xf32> {
  %c0 = arith.constant 0 : index
  %res = vector.gather %mem[%c0] [%indices: vector<6x4xindex>], %mask, %pass_thru : memref<?xf32>, vector<6x4xi1>, vector<6x4xf32> into vector<6x4xf32>
  return %res : vector<6x4xf32>
}
